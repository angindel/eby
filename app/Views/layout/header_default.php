...
<head>
	...
	<meta name="description" content="<?= esc($meta_deskripsi) ?>">
	...
	<meta property="og:description" content="<?= esc($meta_deskripsi) ?>" />
	<meta property="og:url" content="<?php echo "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>" />
	<meta property="og:site_name" content="<?= esc($nama_website) ?>" />
